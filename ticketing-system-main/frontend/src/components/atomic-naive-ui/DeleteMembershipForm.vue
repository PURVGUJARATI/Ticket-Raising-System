...
<template>
  <n-form ref="formRef" :size="medium" label-placement="top"
    style="min-width: 300px; width: 40%; max-width: 500px; background-color: #2c2c2c; padding: 20px; border-radius: 5px;">
    <n-grid :span="24" :x-gap="24" :cols="1">
      <n-gi :span="24" style="color: #fff;">Do you really want to delete this membership?</n-gi>
      <n-gi> &nbsp; </n-gi>
      <n-gi :span="24">
